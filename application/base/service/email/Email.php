...
namespace app\base\service\email;
...
//    安装
//          删除 composer.lock
//          插件 composer require txthinking/mailer ^2.0
    ...
    private $config = [
        ...
        'mail_smtp_port' => '465',
        //SMTP用户名
        'mail_smtp_user' => 'a35920@126.com',
        //SMTP密码 或者是 设备授权码
        'mail_smtp_pass' => 'YRIQREKMSVBYHSSW',
        //SMTP验证方式
        'mail_verify_type' => '2',
        //发件人邮箱
        'mail_from' => 'a35920@126.com',
    ];
    ...
    public function send()
    {
        ...
        if (in_array($this->options['mail_type'], [1, 2])) {
            ...
            //邮件功能已关闭
            $this->setError('Mail already closed');
        }
        return $result;
    }
